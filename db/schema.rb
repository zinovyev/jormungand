...
ActiveRecord::Schema.define(version: 20170419033848) do
  ...
  add_index "category_custom_fields", ["category_id", "custom_field_id"], name: "index_category_custom_fields_on_category_id_and_custom_field_id", using: :btree
  add_index "category_custom_fields", ["custom_field_id"], name: "index_category_custom_fields_on_custom_field_id", using: :btree
  ...
  add_index "emails", ["confirmation_token"], name: "index_emails_on_confirmation_token", using: :btree
  ...
  add_index "shipping_addresses", ["transaction_id"], name: "index_shipping_addresses_on_transaction_id", using: :btree
  ...
  create_table "stripe_payment_gateways", force: :cascade do |t|
    t.integer  "community_id",           limit: 4
    t.string   "stripe_publishable_key", limit: 255
    t.string   "stripe_secret_key",      limit: 255
    t.string   "stripe_client_id",       limit: 255
    t.integer  "commission_from_seller", limit: 4
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  end
  ...
  create_table "transaction_process_tokens", force: :cascade do |t|
  ...
  add_index "transaction_process_tokens", ["process_token"], name: "index_transaction_process_tokens_on_process_token", unique: true, using: :btree
  add_index "transaction_process_tokens", ["transaction_id", "community_id", "op_name"], name: "index_paypal_process_tokens_on_transaction", unique: true, using: :btree
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.string   "listing_author_id",                 limit: 255,                  null: false
  ...
  add_index "transactions", ["listing_author_id"], name: "index_transactions_on_listing_author_id", using: :btree
  add_index "transactions", ["listing_id"], name: "index_transactions_on_listing_id", using: :btree
  add_index "transactions", ["starter_id"], name: "index_transactions_on_starter_id", using: :btree
